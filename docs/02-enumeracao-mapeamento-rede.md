---
description: "Ferramentas de enumeração ativa e mapeamento de redes, hosts, portas, serviços e sistemas operacionais."
---
...
!!! warning "Exija autorização e controle a intensidade"
    Varreduras ativas geram tráfego diretamente contra o ambiente avaliado. Confirme o escopo por escrito, defina limites de taxa e acompanhe a disponibilidade dos serviços críticos durante a execução.

| Ferramenta | Camada/escopo principal | Melhor aplicação | Principal cuidado |
| --- | --- | --- | --- |
| Nmap | Camadas 3–7 | Descoberta detalhada, versões, SO e NSE | Varreduras agressivas podem gerar alertas ou impacto |
| Masscan | Camadas 3–4, grande escala | Triagem extremamente rápida de portas | Taxas elevadas podem saturar links e equipamentos |
